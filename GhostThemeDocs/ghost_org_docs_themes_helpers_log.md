...
If you’re developing a theme and running an install [using Ghost-CLI](https://ghost.org/docs/install/local/), you must use `NODE_ENV=development ghost run` to make debug output visible in the console.
