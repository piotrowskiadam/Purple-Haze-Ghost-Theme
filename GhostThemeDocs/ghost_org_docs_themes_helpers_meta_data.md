...
Ghost generates automatic meta data by default, but it can be overridden with custom content in the post settings menu. Meta data is output by default in [ghost\_head](https://ghost.org/docs/themes/helpers/ghost_head_foot/), and can also be used in themes with the following helpers:
